...
- **Samplers**: No-U-turn sampler (NUTS) via NumPyro and [microcanonical Langevin Monte Carlo](https://microcanonical-monte-carlo.netlify.app/#overview) (MCLMC) via BlackJAX.  The MCLMC sampler is faster than NUTS for high-dimensional datasets, but is still experimental.  
